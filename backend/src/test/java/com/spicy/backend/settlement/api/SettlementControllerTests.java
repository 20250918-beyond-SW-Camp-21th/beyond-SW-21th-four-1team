...
class SettlementControllerTests {
    ...
    class DownloadMonthlySettlementPdf {
        ...
        void success() throws Exception {
            ...
            given(settlementService.getMonthlySettlement(any()))
                    .willReturn(MonthlySettlementResponse.builder().build());
    ...
    class CreateSettlement {
        ...
        void success() throws Exception {
            // DailySettlementRequest가 (storeId, date)로 변경됐다는 전제
            DailySettlementRequest request = new DailySettlementRequest(1L, LocalDate.of(2026, 1, 18));
