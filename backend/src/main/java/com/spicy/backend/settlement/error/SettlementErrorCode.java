...
public enum SettlementErrorCode implements BaseErrorCode { // 기존 프로젝트 구조에 맞게 implements
    ...
    INVALID_SETTLEMENT_AMOUNT(HttpStatus.BAD_REQUEST, "정산 금액 계산이 올바르지 않습니다.", "S004"),
    PDF_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "PDF 영수증 생성 중 오류가 발생했습니다.", "S005"),

    // 로컬 파일 시스템 관련 에러
    FILE_STORAGE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "파일 시스템에 영수증을 저장하지 못했습니다.", "S006"),
    FILE_NOT_FOUND(HttpStatus.NOT_FOUND, "서버에서 해당 영수증 파일을 찾을 수 없습니다.", "S007");
